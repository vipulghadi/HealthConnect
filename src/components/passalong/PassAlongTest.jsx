...
const designs = [
  [['red', 'red', 'blue'], ['blue', 'empty', 'red'], ['blue', 'red', 'blue']],
  [['blue', 'red', 'red'], ['red', 'blue', 'empty'], ['blue', 'blue', 'red']],
  [['red', 'blue', 'red'], ['blue', 'red', 'blue'], ['empty', 'red', 'blue']],
  [['blue', 'red', 'blue'], ['red', 'blue', 'red'], ['blue', 'empty', 'red']],
  [['red', 'blue', 'empty'], ['blue', 'red', 'blue'], ['red', 'blue', 'red']],
  [['blue', 'red', 'blue'], ['red', 'empty', 'red'], ['blue', 'blue', 'red']],
  [['red', 'blue', 'red'], ['blue', 'red', 'blue'], ['red', 'blue', 'empty']],
  [['blue', 'red', 'blue'], ['red', 'blue', 'red'], ['empty', 'blue', 'red']],
]
...
export default function PassAlongTest() {
  ...
  function saveResponse(response) {
    if (typeof window !== 'undefined') {
      ...
      localStorage.setItem('passAlongResponses', JSON.stringify(updatedResponses))
        ...
        <CardContent className="p-6 sm:p-8">
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
            <div className="space-y-6">
              ...
              <div className="flex flex-wrap gap-3 sticky top-0 bg-gray-100/90 p-4 -mx-4 rounded-t-lg shadow-sm">
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent className="rounded-md shadow-md">Begin the current design</TooltipContent>
                  </Tooltip>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button
                    ...
                    <TooltipContent className="rounded-md shadow-md">Pause and submit your solution</TooltipContent>
                  </Tooltip>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button
              ...
              {score !== null && (
                <div className="flex items-center gap-3 text-xl animate-slide-up">
                  <Award className="h-6 w-6 text-yellow-500" />
                  <p className="text-gray-800">
                    Score: <span className="font-bold">{score}</span> {score === 1 ? 'point' : 'points'}
                  </p>
                </div>
              )}
              {showSuccess && (
                <div
                  className="absolute inset-0 flex items-center justify-center bg-green-600/80 rounded-xl animate-fade-in"
                  aria-live="polite"
                >
